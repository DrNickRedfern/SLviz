intro_panel <- tabPanel(
 ...
 #  tags$hr(style = "border-color: purple;"),
  ...
  p("Good data visualisations are ", tags$em("descriptive"), 
    ", effectively summarising the information in a data set simply and efficiently; they are ",
  ...
  p("To get started you need to upload some shot length data to ", tags$b("SLviz"), ". You can do this on the ", tags$b("Upload data"),
    "page. ", tags$b("SLviz"), " accepts data in the ", tags$b("csv"), " file format. Once uploaded, you will be able to choose the 
    data for a particular film(s) on the other pages in the app."),
  ...
  p(tags$b("Two groups"), "of films can also be visualised by selecting different groups of films from a single csv file."),
  p("The ", tags$b("glossary"), "contains brief descriptions of each of the summaries and visualisations available in ", tags$b("SLviz"), ". 
    There are also links to get more information."),
